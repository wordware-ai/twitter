...
//     OG({
//       title: title ?? 'Twitter Personality',
...
// function OG({ title, description, mode }: { mode: Mode; title: string; description: string }): React.ReactElement {
//   return (
//     <div
//       style={{
//         color: foreground,
